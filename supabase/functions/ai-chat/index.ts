...
- **التسعير**: psychological pricing (.99, الأسعار المرجعية)، الـ bundles، الشحن المجاني كعتبة (free shipping threshold = AOV + 20-30%)، الخصومات الذكية (لا تتجاوز 30% عادةً)، isير msrح msrحي msrح.
