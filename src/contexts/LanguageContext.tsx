...
const translations: Translations = {
  ...
  'nav.droopai': { en: 'DROOP AI', ar: 'دروب AI', fr: 'DROOP AI' },
  ...
  // AI Chat
  'ai.title': { en: 'DROOP AI Assistant', ar: 'مساعد دروب AI', fr: 'Assistant DROOP AI' },
  'ai.placeholder': { en: 'Ask DROOP AI about business strategies...', ar: 'اسأل دروب AI عن استراتيجيات العمل...', fr: 'Demandez à DROOP AI des stratégies commerciales...' },
